...
// Button GPIOs
enum ButtonGpio {
    BUTTON_PRESET1_GPIO = 9,
    BUTTON_DRIVE_GPIO = 9,

    BUTTON_PRESET2_GPIO = 5,
    BUTTON_MOD_GPIO = 5,


    BUTTON_PRESET3_GPIO = 10,
    BUTTON_DELAY_GPIO = 10,


    BUTTON_PRESET4_GPIO = 38,
    BUTTON_REVERB_GPIO = 38,

    BUTTON_BANK_DOWN_GPIO = 2,
    BUTTON_NOISEGATE_GPIO = 2,
